...
document.querySelector('#app').innerHTML = `
  ...
  <header class="topbar">
    <a class="brand" href="./" aria-label="Vigilante Gameplay, accueil"><span class="brand-mark">L<span>·</span></span><span>VIGILANTE GAMEPLAY<small>V5 / ACTION & EXPLORATION</small></span></a>
  ...
  <aside class="map-panel"><div class="map-heading"><span><i></i> <span id="district-name">VIGILANTE GAMEPLAY</span></span><span>N ↑</span></div><canvas id="minimap" width="224" height="170" aria-label="Plan du quartier et position du joueur"></canvas><div class="district-legend"><span class="downtown">Downtown</span><span class="old">Old Gotham</span><span class="industrial">Industrial</span><span class="docks">Docks</span></div><div class="landmark-legend" title="Cathédrale des Veilleurs · Tour Meridian · Hôtel de la Garde">C Cathédrale · T Tour · M Mairie</div><div class="map-footer"><span id="coordinates">X 000 · Z 000</span><span id="sector">CHUNK 4,4</span></div></aside>
...
export function bindSettings(living, signal) {
  ...
  panel.setAttribute('aria-label', 'Réglages de Vigilante Gameplay');
